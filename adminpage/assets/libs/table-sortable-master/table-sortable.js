    ...
    var s,
      ...
      v = function (t, e) {
        ...
        for (var n = 0, a = t.length, i = []; n < a; )
          e.apply(null, [t[n], n]) && i.push(t[n]), (n += 1);
        return i;
      },
      y = function (t, e) {
        var n;
        if (!t) {
          for (
            var a = arguments.length, i = new Array(a > 2 ? a - 2 : 0), r = 2;
            r < a;
            r++
          )
            i[r - 2] = arguments[r];
      ...
      D = (function () {
        function t() {
          i(this, t),
            ...
            (this._datasetLen = 0),
            (this._outLen = 10),
            (this.sortDirection = { ASC: "asc", DESC: "desc" });
        }
        return (
          o(t, [
            {
              ...
              value: function (t, e, n) {
                ...
                y.apply(
                  ...
                  [
                    t,
                    "".concat(this._name, ".").concat(e, " ").concat(n),
                  ].concat(r)
                );
              },
            },
              ...
              value: function (t) {
                return (
                  ...
                  t
                    ...
                    : ((t = Math.max(this._datasetLen - this._outLen, 0)),
                      this.dataset.slice(t, this._datasetLen))
                );
              },
            },
      ...
      x = function (t, e, n) {
        return { node: t, attrs: e, children: n };
      },
      S = function (t) {
        var e = t.node,
          n = t.attrs;
      ...
      L = function () {
        return { createElement: x, render: U };
      },
      O =
        (n(2),
        (function () {
            ...
            i(this, t),
              ...
              (this.setData = function (t, e, a) {
                n.logError(
                  ...
                  n._isMounted &&
                    t &&
                    (a ? n._dataset.pushData(t) : n._dataset.fromCollection(t),
              ...
              (this.distroy = function () {
                n._isMounted &&
                  (n.emitLifeCycles("tableWillUnmount"),
                  n._table.remove(),
                  n._styles &&
                    n._styles.length &&
                    (n._styles.remove(), (n._styles = null)),
                  (n._dataset = null),
                  (n._table = null),
                  (n._thead = null),
                  (n._tbody = null),
            ...
            o(t, [
              {
                ...
                value: function () {
                  ...
                  this.logWarn(
                    t.columnsHtml,
                    "columnsHtml",
                    "has been deprecated. Use formatHeader()"
                  ),
                    this.logWarn(
                      t.processHtml,
                      "processHtml",
                      "has been deprecated. Use formatCell()"
                    ),
                    this.logWarn(
                      t.dateParsing,
                      "dateParsing",
              ...
              },
              {
                ...
                value: function (t, e) {
                  ...
                  h(t) &&
                    w(t, [0, n]) &&
                    ((this._pagination.currentPage = t),
              ...
              },
              {
                ...
                value: function () {
                  this._table =
                    u()("<table></table>").addClass("table gs-table");
                },
              },
              {
                key: "_initDataset",
                ...
                value: function (t) {
                  ...
                  t !== a && (n = ""),
                    n
                      ...
                      : (n = this._dataset.sortDirection.ASC),
                    (a = t),
                    (this._sorting = { dir: n, currentCol: a }),
                ...
                value: function (t, e) {
                  ...
                  return a
                    ? (a &&
                        ...
                        e === this._sorting.currentCol &&
                          this._sorting.dir &&
                          t.append(
                            this.options.sortingIcons[this._sorting.dir]
                          ),
                        t.click(function (t) {
                          i.sortData(e);
                        })),
                      c(a) &&
                        b(a, function (a) {
                          e === a &&
                            ((t = u()(t)).attr("role", "button"),
                            t.addClass("gs-button"),
                            e === n._sorting.currentCol &&
                              n._sorting.dir &&
                              t.append(n.options.sortingIcons[n._sorting.dir]),
                            t.click(function (t) {
                              i.sortData(e);
                            }));
                        }),
              ...
              },
              {
                ...
                value: function () {
                  ...
                  var r = i * a,
                    o = Math.min(r + a, t);
                  return { from: (r = Math.min(r, o)), to: o };
                },
              },
              {
                key: "_renderHeader",
                value: function (t) {
                  ...
                  b(o, function (t, n) {
                    ...
                    var s = e.engine.createElement("th", { html: o });
                    r.push(s);
                  });
                  ...
                  return (
                    b(l, function (t, n) {
                      ...
                      b(h, function (n) {
                        ...
                        void 0 !== t[n] &&
                          ((r = f(i)
                            ? e.createElement("td", { html: i(t, n) })
                            : e.createElement("td", { html: t[n] })),
                          a.push(r));
                      }),
                ...
                value: function (t) {
                  ...
                  if (
                    (c > f / 2 && c < h - f / 2
                      ...
                      : c > h - f / 2 && ((p = h - f), (g = h)),
                    t ||
                      ((t = u()('<div class="gs-pagination"></div>')),
                  ...
                  for (var v = p; v < g; ) {
                    var y = n.createElement("button", {
                      className:
                        c === v ? "btn btn-primary active" : "btn btn-default",
                      onClick: function () {
                  ...
                  var k = this.getCurrentPageIndex(),
                    ...
                    w = n.createElement("span", {
                      text: "Showing "
                        .concat(Math.min(E, C + 1), " to ")
                        .concat(E, " of ")
                        .concat(this._dataset._datasetLen, " rows"),
                    }),
                    D = n.createElement("div", { className: "col-md-6" }, w),
                    x = n.createElement(
                      "div",
                      { className: "btn-group d-flex justify-content-end" },
                      _
                    ),
                    S = n.createElement("div", { className: "col-md-6" }, x),
                    U = n.createElement("div", { className: "row" }, [D, S]);
                  return n.render(U, t);
                },
              },
              {
              ...
              },
              {
                ...
                value: function () {
                  if (this._rootElement.is("table"))
                    ...
                    this._rootElement = this.engine.render(
                      t,
                      this._rootElement
                    );
                  }
              ...
              },
              {
                ...
                value: function () {
                  ...
                  if (
                    ...
                    d(i)
                      ? (this._cachedOption ||
                          (this._cachedOption = u.a.extend({}, this.options)),
