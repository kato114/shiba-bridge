...
const PhishingWarningBanner: React.FC<React.PropsWithChildren> = () => {
  ...
  const warningTextAsParts = useMemo(() => {
    const warningText = t("please make sure you're visiting https://shibwallet.app - check the URL carefully.")
    return warningText.split(/(https:\/\/shibwallet.app)/g)
  }, [t])
    ...
    <>
      ...
      {warningTextAsParts.map((text, i) => (
        <Text
          ...
          small
          as="span"
          bold={text === 'https://shibwallet.app'}
          color={text === 'https://shibwallet.app' ? '#FFFFFF' : '#BDC2C4'}
        >
          {text}
        </Text>
      ))}
