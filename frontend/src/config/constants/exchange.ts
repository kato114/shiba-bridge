...
export const ROUTER_ADDRESS: ChainMap<string> = {
  [ChainId.ETHEREUM]: '',
  [ChainId.RINKEBY]: '',
  [ChainId.GOERLI]: '0xc4C9A5EF9db85BA399eB41FA829c78F96E2ca769',
  [ChainId.BSC]: '',
...
export const LIMIT_ORDERS_DOCS_URL = 'https://docs.shibwallet.app/products/obridge-exchange/limit-orders'
