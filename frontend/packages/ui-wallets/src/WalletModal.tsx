  ...
  const imageSources = useMemo(
    () =>
      wallets
        ...
        .concat(
          'https://static.wixstatic.com/media/cbedf8_a28a501eb2114a11ad7e18fa5667c5d7~mv2.png/v1/fill/w_50,h_50,al_c,q_85,usm_0.66_1.00_0.01,enc_auto/cbedf8_a28a501eb2114a11ad7e18fa5667c5d7~mv2.png',
        ) as string[],
    [wallets],
  )
